...
- (void)buildFooterView {
    ...
    //设置选中页的圆点颜色
    self.pageControl.currentPageIndicatorTintColor=RGBA(70, 70, 70, 1);
    ...
    [self.skipButton setTitleColor:RGBA(70, 70, 70, 1) forState:(UIControlStateNormal)];
    [self.skipButton setTitleColor:RGBA(70, 70, 70, 1) forState:(UIControlStateHighlighted)];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if(page == pageViews.count-1){
        self.skipButton.frame = CGRectMake(self.scrollView.frame.size.width - 100, self.pageControl.frame.origin.y, 80, self.pageControl.frame.size.height);
        [self.skipButton setTitle:NSLocalizedString(@"进入首页", nil) forState:UIControlStateNormal];
    }
//    if (page == 1) {
//        [self.skipButton setTitleColor:RGBA(70, 70, 70, 1) forState:(UIControlStateNormal)];
//        [self.skipButton setTitleColor:RGBA(70, 70, 70, 1) forState:(UIControlStateHighlighted)];
//        //设置非选中页的圆点颜色
//        self.pageControl.pageIndicatorTintColor = RGBA(228, 92, 92, 1);
//        //设置选中页的圆点颜色
